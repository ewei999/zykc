...
begin
  ...
  ADOQuery_cg_zhubiao.SQL.Text := 'select top 0 * from ÖÐÑë²É¹ºÉêÇëÖ÷±í';
  ADOQuery_cg_zhubiao.Active := true;
  ADOQuery_cg_zhubiao.Append;
  ADOQuery_cg_zhubiao.FieldByName('ÉêÇë±àºÅ').AsString := AutoCreateNo('CG','²É¹ºÉêÇë');
  ADOQuery_cg_zhubiao.FieldByName('ÉêÇëÈÕÆÚ').AsDateTime := XiTong_date;
  ADOQuery_cg_zhubiao.FieldByName('ÉêÇëÈË').AsString := G_user.UserName;
  ADOQuery_cg_zhubiao.FieldByName('Ô±¹¤±àºÅ').AsString := G_user.userID;
  ADOQuery_cg_zhubiao.FieldByName('×´Ì¬').AsString := '0';
  ADOQuery_cg_mingxi.Active := False;
  ADOQuery_cg_mingxi.SQL.Text := 'select * from ÖÐÑë²É¹ºÉêÇëÃ÷Ï¸±í where ÉêÇë±àºÅ='+
                                  QuotedStr(ADOQuery_cg_zhubiao.FieldByName('ÉêÇë±àºÅ').AsString);
...
//  ADOQuery_cg_mingxi.Active := True;
  ...
  Form_cg_new.ADOQuery_cg_mingxi.FieldByName('ÉêÇë±àºÅ').AsString := ADOQuery_cg_zhubiao.FieldByName('ÉêÇë±àºÅ').AsString;
