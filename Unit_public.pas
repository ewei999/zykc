...
begin
  ...
  try
    ADOQuery_danjia.Connection := DataModule1.ADOCon_ALi;
    ADOQuery_danjia.SQL.Text := 'select ¹©Ó¦ÉÌ,½ø»õµ¥¼Û,sum(Åú´ÎÊ£Óà¿â´æÊı) as Åú´ÎÊ£Óà¿â´æÊı,Ãû³Æ=(select top 1 Ãû³Æ from ¹©Ó¦ÉÌ±í where ¹©Ó¦ÉÌ±àºÅ=c.¹©Ó¦ÉÌ),Õû¸¶ÊıÁ¿,Õû¸¶½ğ¶î '+
    ...
    ' from ( select ¼ÛÄ¿±àºÅ,Èë¿âÅú´Î,½ø»õµ¥¼Û,ÊıÁ¿,Õû¸¶ÊıÁ¿,Õû¸¶½ğ¶î,¹©Ó¦ÉÌ=(select top 1 ¹©Ó¦ÉÌ from ÖĞÑë²É¹ºÈë¿âÖ÷±í where Èë¿â±àºÅ=ÖĞÑë²É¹ºÈë¿âÃ÷Ï¸±í.Èë¿â±àºÅ) from ÖĞÑë²É¹ºÈë¿âÃ÷Ï¸±í  '+
    ' where ¼ÛÄ¿±àºÅ='+QuotedStr(jmbh)+' and Èë¿â±àºÅ in (select Èë¿â±àºÅ from ÖĞÑë²É¹ºÈë¿âÖ÷±í where ×´Ì¬=1 ) )a)b)c where Åú´ÎÊ£Óà¿â´æÊı>0 group by ¹©Ó¦ÉÌ,½ø»õµ¥¼Û,Õû¸¶ÊıÁ¿,Õû¸¶½ğ¶î' ;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              and (ADOBianHao.FieldByName('Õû¸¶½ğ¶î').asfloat=ADOQuery_danjia.FieldByName('Õû¸¶½ğ¶î').asfloat)              then
              begin
                i_int:=1;
                ADOBianHao.Edit;
